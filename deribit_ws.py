...
#Concept ใช้ parameter ในการดึงข้อมูลแยกประเภท
...
class WS_Client(object):
    ...
    def sell(self, instrument_name, amount, order_type, reduce_only,
        ...
        return self.loops(self.private_api, self.json)
    # sell stop order
    ...
    def get_instrument(self,currency,kind):
        options = {"currency" : currency,
                   "kind" : kind}
    ...
    def get_tradingview_chart_data(self, instrument, resolution):
        options = {"instrument": instrument,
                   "resolution": resolution}
        self.json["method"] = "public/get_tradingview_chart_data"
        self.json["params"] = options
        return self.loop(self.public_api, self.json)
