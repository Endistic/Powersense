...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 20, 331, 71))
        ...
        self.name_id = QtWidgets.QLineEdit(self.groupBox)
        self.name_id.setGeometry(QtCore.QRect(80, 20, 113, 20))
        self.name_id.setObjectName("Name")
        # self.serect_key = QtWidgets.QLineEdit(self.groupBox)
        # self.serect_key.setGeometry(QtCore.QRect(80, 40, 113, 20))
        # self.serect_key.setObjectName("serect_key")
        self.ok_button = QtWidgets.QPushButton(self.groupBox)
        self.ok_button.setGeometry(QtCore.QRect(200, 20, 41, 41))
        self.ok_button.setObjectName("ok_button")
        self.clear_button = QtWidgets.QPushButton(self.groupBox)
        self.clear_button.setGeometry(QtCore.QRect(260, 20, 51, 41))
        ...
        # self.clear_button.clicked.connect(self.order_books)
        self.market_price()
        self.radiobutton()
        ...
        # self.ok_button.clicked.connect(self.api_key.hide)
        # self.ok_button.clicked.connect(self.serect_key.hide)
        # self.clear_button.clicked.connect(self.api_key.show)
        # self.clear_button.clicked.connect(self.serect_key.show)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Input Name or ID"))
    ...
    # def call_object_value(self, _symbol):
    #     _symbol = None
    #     if _symbol == _perpetual:
    #         self.order_books(_perpetual)
    #     elif _symbol == _sep:
    #         self.order_books(_sep)
    #     elif _symbol == _dec:
    #         self.order_books(_mar)
    #     elif _symbol == _mar:
    #         self.order_books(_dec)
    # clicked() = signal for when clicked
    # setIcon(icon) = set icon
    # isChecked() = returns if button is selected
    # setChecked(bool) = set if the button is selected
    def openDialog(self):
    ...
    def market_price(self):
        ...
        # setIcon(icon) = set icon
        # isChecked() = returns if button is selected
        # setChecked(bool) = set if the button is  if self.radioButton.setChecked(True):



        # if self.radioButton.clicked.connect(self.order_books_per):
        #     self.order_box.setTitle(_perpetual)
        # elif self.radioButton_2.clicked.connect(self.order_books_sep):
        #     self.order_box.setTitle(_sep)
        # elif self.radioButton_2.clicked.connect(self.order_books_dec):
        #     self.order_box.setTitle(_dec)
        # elif self.radioButton_2.clicked.connect(self.order_books_mar):
        #     self.order_box.setTitle(_mar)
